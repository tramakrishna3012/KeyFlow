    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          findsOneWidget,
          reason:
              'BUG: Windows with 1200px width shows BottomNavigationBar '
        ...
        expect(
          ...
          findsNothing,
          reason:
              'Expected: NavigationRail should be used for desktop width. '
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          findsOneWidget,
          reason:
              'BUG: macOS with 1400px width shows BottomNavigationBar '
              'instead of NavigationRail. This confirms the bug exists.',
        );
      },
    );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          findsOneWidget,
          reason:
              'BUG: Web with 800px width shows BottomNavigationBar '
              'instead of NavigationRail. This confirms the bug exists.',
        );
      },
    );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          findsOneWidget,
          reason:
              'Mobile width should continue to use BottomNavigationBar '
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        if (tester.any(bottomNavBar)) {
          // ignore: avoid_print
          print(
            'Counterexample documented: 600px width uses BottomNavigationBar',
          );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          if (hasBottomNav) {
            // ignore: avoid_print
            print(
              'Counterexample: Width $width px uses BottomNavigationBar '
          ...
          expect(
            ...
            isTrue,
            reason:
                'BUG: Width $width px shows BottomNavigationBar. '
