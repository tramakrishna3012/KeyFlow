...
void main() {
  group('DartSessionAggregator Tests', () {
    test('Groups typing keystrokes into persistent paragraph session', () async {
      ...
      expect(lastUpdated!.content, equals('First draft sentence. Second paragraph added.'));

      aggregator.dispose();
    });

    test('Excludes password and sensitive inputs while allowing calculator', () {
      final aggregator = DartSessionAggregator();
