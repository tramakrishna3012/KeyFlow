...
class AuthModal extends ConsumerStatefulWidget {
  ...
  static Future<bool?> show(BuildContext context, {bool initialIsSignUp = false}) {
...
class _AuthModalState extends ConsumerState<AuthModal>
  ...
  Future<void> _handleBiometricSignIn() async {
    ...
    if (user != null || AppAuthNotifier.debugAuthenticatedOverride == true) {
      ...
      setState(() {
        _errorMessage = 'No biometric credentials enrolled. Please sign in with password.';
        _isLoading = false;
      });
    }
  }
  ...
  void _showForgotPasswordDialog() {
    final emailController = TextEditingController(text: _signInEmailController.text);
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Reset Password', style: TextStyle(fontSize: 18, color: AppColors.textPrimary)),
        content: Column(
                ...
                child: Row(
                  children: [
                    ...
                    InkWell(
                      ...
                      child: const Icon(Icons.close, size: 16, color: AppColors.destructive),
                    ),
                  ],
                ),
              ),
          ...
          Row(
            ...
            children: [
              ...
              InkWell(
                ...
                child: const Text(
                  'Forgot password?',
                  style: TextStyle(fontSize: 12, color: AppColors.primaryLight, fontWeight: FontWeight.w500),
                ),
              ),
            ],
          ),
          ...
          TextFormField(
            ...
            decoration: _inputDecoration(
              ...
              suffixIcon: IconButton(
                icon: Icon(
                  _signInObscurePassword ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                  color: AppColors.textMuted,
                  size: 18,
                ),
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: IconButton(
                  icon: const Icon(Icons.fingerprint, color: AppColors.primaryLight, size: 24),
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: _inputDecoration(
              ...
              suffixIcon: IconButton(
                icon: Icon(
                  _signUpObscurePassword ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                  color: AppColors.textMuted,
                  size: 18,
                ),
          ...
          if (_signUpPasswordController.text.isNotEmpty) ...[
            ...
            Row(
              children: [
                ...
                Text(
                  strengthLabel,
                  style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: strengthColor),
                ),
              ],
            ),
          ],
          ...
          // Confirm Password
          const Text('Confirm Password', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.textSecondary)),
          const SizedBox(height: 6),
          TextFormField(
            ...
            decoration: _inputDecoration(
              ...
              suffixIcon: IconButton(
                icon: Icon(
                  _signUpObscureConfirm ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                  color: AppColors.textMuted,
                  size: 18,
                ),
    ...
    return Row(
      children: [
        ...
        Padding(
          ...
          child: Text(
            text,
            style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: AppColors.textMuted, letterSpacing: 1.1),
          ),
        ),
        const Expanded(child: Divider(color: AppColors.cardBorder)),
      ],
